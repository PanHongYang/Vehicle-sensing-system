...
"""autogenerated by genpy from canfd_msgs/Frame.msg. Do not edit."""
import codecs
import sys
...
class Frame(genpy.Message):
  _md5sum = "67a2d3c780aad66c439e5e1657c0ce8e"
  _type = "canfd_msgs/Frame"
...
string frame_id
"""
  __slots__ = ['header','interface','id','is_rtr','is_extended','is_error','len','data']
  _slot_types = ['std_msgs/Header','string','uint32','bool','bool','bool','uint8','uint8[64]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,interface,id,is_rtr,is_extended,is_error,len,data
